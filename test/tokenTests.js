...
contract('Testing Snowflake Token Functionality', function (accounts) {
  ...
  describe('Deposit Logic', async () => {
    ...
    it('cannot deposit PHNX without an EIN', async () => {
      await instances.PhoenixToken.approveAndCall(
        instances.Snowflake.address, depositAmount, '0x00', { from: accounts[0] }
      )
    ...
    it('owner can deposit 50 PHNX to an EIN', async () => {
      await instances.PhoenixToken.approveAndCall(
    ...
    it('can deposit 50 PHNX to own EIN', async () => {
      await instances.PhoenixToken.approveAndCall(
  ...
  describe('Testing self initiated methods', async () => {
    ...
    it('can transfer PHNX from 1 snowflake to another', async () => {
    ...
    it('can withdraw PHNX from from a snowflake', async () => {
